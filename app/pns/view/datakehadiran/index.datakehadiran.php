                    ...
                    <div id="showTabel" class="card stats-card">
                        <div class="card-action" style="padding-bottom: 0px">
                            <form id="frmData" class="navbar-search expanded" onsubmit="return false" role="search" >
                                ...
                                <?= comp\MATERIALIZE::inputKey('pin_absen', $dataPersonal['pin_absen']); ?>
                                <?php // comp\FUNC::showPre($dataPersonal) ?>

                                <div class="row">
                                    <div class="input-field col s6" style="margin-top: 0px">
                                        <h5 id="nama_personil"><?= $dataPersonal['nama_personil'] ?></h5>
                                        <h6 id="nip_personil">NIP. <?= $dataPersonal['nipbaru'] ?></h6>
                                    </div>
                                    <div class="input-field col">
                                        <label for="sdate" class="active">Tanggal Awal</label>
                                        <?= comp\MATERIALIZE::inputText('sdate', 'text', $tanggal['sdate'], 'class="datepicker picker_input active"') ?>
                                    </div>
                                    <div class="input-field col">
                                        <label for="edate" class="active">Tanggal Akhir</label>
                                        <?= comp\MATERIALIZE::inputText('edate', 'text', $tanggal['edate'], 'class="datepicker picker_input"') ?>
                                    </div>
                                    <div class="input-field col">
                        ...
                        <div class="card-content" style="padding-top: 0px">
                            ...
                            <div id="showSpinner" class="row" style="display: none; margin-top: 100px">
                                <?php $this->getView('pns', 'main', 'spinner', '') ?>
                            </div>
                            <!-- end Spinner -->
