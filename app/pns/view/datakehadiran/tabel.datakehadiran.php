            ...
            <tr>
                ...
                <td class="center">
                    ...
                    if ($status != $status_verified) {
                        ?>
                        <a onclick="app.showForm('<?= $pin ?>', '<?= $tgl ?>', '<?= $jam ?>', '<?= $status ?>')" href="javascript:void(0)" class="btnEditStat chip hoverable orange white-text">
                            <?= $status_verified ?>
                        ...
                        ?>
                        <a onclick="app.showForm('<?= $pin ?>', '<?= $tgl ?>', '<?= $jam ?>', '<?= $status ?>')" href="javascript:void(0)" class="btnEditStat chip hoverable green white-text">
                            <?= $status_verified ?>
                        </a>
                        <?php
                    }
