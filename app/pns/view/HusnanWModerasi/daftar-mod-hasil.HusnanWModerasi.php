...
<div class="row">
    <div class="col s12">
        <h4 class="center" style="padding-top:25px;"><p>Daftar Hasil Akhir Moderasi PNS yang Mengajukan Moderasi Ketidakhadiran</p></h4>
    </div>
</div> 
<hr>
...
<div class="row">
    <div class="col s7">
        ...
        <div class="row">
            ...
            <div class="col s3">
                <a id="btnFilterTgl" class="waves-effect waves-light btn" action-value="hasil">Tampilkan</a>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div id="divTabelDaftarModHasil" class="col s12">        
