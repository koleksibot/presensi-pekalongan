    ...
    <table class="bordered hoverable custom-border custom-portrait">
        ...
        <tbody>
            ...
            if (isset($rekapbc[$peg['id']])) {
                ...
                $tpp36 = $peg['nominal_tp'] * 36 / 100;
                $tpp24 = $peg['nominal_tp'] * 24 / 100;
                $rupiah_pot = $tpp36 * $sum_pot['all'] / 100;
                $rupiah_pot_kinerja = $tpp24 * (100 - $find['poin_kinerja']) / 100;
        ...
        <tfoot>
            ...
            <tr class="grey lighten-2">
                ...
                <td class="center-align">
                    <b>
                        <?= ($find['poin_kinerja'] < 100) ? 100 - $find['poin_kinerja'] . '%' : '' ?>
                        <?= empty($rupiah_pot_kinerja) ? '-' : '(Rp ' . number_format($rupiah_pot_kinerja, 0, ",", ".") . ')' ; ?>
                    </b>
                </td>
            </tr>
            <tr class="grey lighten-2">
