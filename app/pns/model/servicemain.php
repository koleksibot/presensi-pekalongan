...
class servicemain extends system\Model {
    ...
    public function cekLogin($data) {
        ...
        $query = "SELECT * FROM tb_pengguna WHERE (username = ?) AND (password = ?) AND grup_pengguna_kd = 'KDGRUP05'";
    ...
    public function login($input) {
        ...
        $query = "SELECT * FROM tb_pengguna WHERE (username = ?) AND grup_pengguna_kd = 'KDGRUP05'";
