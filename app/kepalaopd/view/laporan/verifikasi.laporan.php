...
*/
?>
<div class="alert-verifikasi alert-verifikasi-ok <?= ($tingkat == 3 && isset($laporan['kepala_opd'])) || ($tingkat == 6 && isset($laporan['final'])) ? '' : 'hide' ?>">
    <span class="blink">
        <i class="fa fa-check-circle"></i>
        Laporan Telah Disahkan Kepala OPD
    </span>
</div>
<div class="alert-verifikasi <?= $tingkat == 3 && !isset($laporan['kepala_opd']) ? '' : 'hide' ?>">
    <span class="blink">
...
<div class="alert-verifikasi <?= $tingkat == 6 && !isset($laporan['final']) ? '' : 'hide' ?>">
    <span class="blink">
        <i class="fa fa-angle-double-down"></i>
        Anda belum melakukan pengesahan laporan final
        <i class="fa fa-angle-double-down"></i>
    </span>
</div>
<div class="row lap">
...
if ((($tingkat == 3 && !isset($laporan['kepala_opd'])) || ($tingkat == 6 && !isset($laporan['final']))) && strtotime(date('Y-m-d')) >= $batas_sahkan && isset($laporan['admin_opd'])) {
    ?>
