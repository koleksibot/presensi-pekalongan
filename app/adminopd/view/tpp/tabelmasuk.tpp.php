...
<table class="bordered hoverable custom-border scrollable" width="100%">
    <thead>
        <tr>
            <th class="orange lighten-4 center-align" rowspan="2" width="50px">No</th>
            <th class="orange lighten-4 center-align" rowspan="2" width="30%">Nama</th>
