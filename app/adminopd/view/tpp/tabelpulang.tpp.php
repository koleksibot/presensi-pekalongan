...
<table class="bordered hoverable custom-border scrollable">
    <thead>
        <tr>
            <th class="light-green lighten-4 center-align" rowspan="2" width="50px">No</th>
            <th class="light-green lighten-4 center-align" rowspan="2" width="30%">Nama</th>
...
if ($tingkat == 6)
    $tingkat = 'Final';
$filename = 'Laporan' . $format . '3-' . $satker['singkatan_lokasi'] . '-' . $namabulan[$bulan - 1] . $tahun . '-tingkat' . $tingkat . '.pdf';
