...
<div class="card horizontal">
    ...
    <div class="card-stacked">
        ...
        <div class="progress no-s">
            <div id="loading" class="determinate" style="width: 0%"></div>
        </div>
    ...
    <tbody>
        ...
        if ($jmlData > 0) {
            foreach ($dataTabel as $kol) {
                $stsHapus = (isset($author[$kol['author']]['grup_pengguna_kd']) and $author[$kol['author']]['grup_pengguna_kd'] == 'KDGRUP99') ? false : true;
                ?>
                <tr>
                    ...
                    <td class="center-align">
                        ...
                        if ($stsHapus) {
                            ...
                            ?>
                            <a class="btn-floating waves-effect red" disabled="disabled">
                                <i class="material-icons">delete</i>
                            </a>
                            <?php
                        }
