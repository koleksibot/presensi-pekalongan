                ...
                <div class="card">
                    ...
                    <div class="card-action center">
                        <?php if ($this->login["grup_pengguna_kd"] === $info["usergroup"] && $info["flag_kepala_opd"] !== "2" && $info["flag_kepala_opd"] !== "3"): ?>
                            <a class="btn-del-mod btn waves-effect waves-light grey" title="saya hapus" mid="<?= $info["id"] ?>"><i class="material-icons left">delete</i> HAPUS MODERASI</a>
                            <hr>
                        <?php //elseif (is_null($info["flag_kepala_opd"]) && $info["usergroup"] === "KDGRUP05"):
                        endif; 
                        if (is_null($info["flag_kepala_opd"])):    
                        ?> 
                            <textarea id="txtCatatan" class="materialize-textarea" placeholder="Berikanlah catatan bila diperlukan"><?= $info["catatan_operator_opd"] ?></textarea>
