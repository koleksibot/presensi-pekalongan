...
<!--<script>-->
    app = {
        ...
        checkMod: function (tingkat) {
            if (tingkat == 2) {
                alert('Maaf, Anda belum bisa cetak laporan DESEMBER 2019 karena ada moderasi s/d tgl 16 yang belum Anda verifikasi.');
                window.location.href = url_mod;
            } else (tingkat == 3)
                alert('Maaf, Anda belum bisa cetak laporan DESEMBER 2019 karena ada moderasi s/d tgl 16 yang belum KEPALA OPD verifikasi.');
        },
