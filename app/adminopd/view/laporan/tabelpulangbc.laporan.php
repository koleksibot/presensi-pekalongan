...
<h5 class="center-align">
    <b>
        Laporan Rekap Kehadiran/Ketidakhadiran Pulang Kerja Karyawan <br>
        OPD/Unit Kerja: <?= $satker['singkatan_lokasi'] ?> Bulan: <?= comp\FUNC::$namabulan1[$bulan] ?> Tahun: <?= $tahun ?>
    </b>
</h5>
            ...
            <tr>
                <td width="50%">
                    ...
                    if ($tingkat == 3) {
                        ...
                        . '(' . comp\FUNC::tanggal($laporan['dt_admin_kota'], 'short_date') . ')';
                    }
                    ?>                
                </td>
                <td width="50%">
                    ...
                    if ($tingkat > 1) {
                        ...
                        . '(' . comp\FUNC::tanggal($laporan['dt_admin_opd'], 'short_date') . ')';
                    }
                    ?>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    if ($tingkat > 4) {
                        ...
                        . '(' . comp\FUNC::tanggal($laporan['dt_kepala_bkppd'], 'short_date') . ')';
                    }
                    ?>
                </td>
                <td>
                    ...
                    if ($tingkat == 6) {
                        ...
                        . '(' . comp\FUNC::tanggal($laporan['dt_final'], 'short_date') . ')';
                    }
                    ?>
                </td>
            </tr>
...
$filename = 'Laporan' . $format . '3-' . $satker['singkatan_lokasi'] . '-' . comp\FUNC::$namabulan1[$bulan] . $tahun . '-tingkat' . $tingkat . '.pdf';
