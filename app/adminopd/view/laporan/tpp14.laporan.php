                ...
                <div class="col s12">
                    ...
                    <div id="showIndex" class="card stats-card">
                        <div class="card-action" style="padding-bottom: 0px">
                            <form id="frmData" class="navbar-search expanded" role="search" method="post" action="<?= $this->link('adminopd/laporan/tabeltpp14') ?>">
                                <div class="row">
                                    ...
                                    <div class="input-field col s1">
                                        <button class="btn-floating btn waves-effect waves-light red" title="Cetak TPP 14" type="button" id="btnCetak">
                                ...
                                <?= comp\MATERIALIZE::inputKey('tpp', 'tpp14'); ?>
