            ...
            <tr>
                ...
                <?php
                    ...
                    for ($i = 1; $i <= $hitungtgl; $i++) {
                        ...
                        $hl = false; $nr = false; $kolom = '';
                        if (isset($rekap[$pin][$i])) {
                            if ($rekap[$pin][$i] == 'HL') {
                                $hl = true;
                                $kolom = '<td></td>';
                            } elseif ($rekap[$pin][$i] == 'A1' || strtotime($rekap[$pin][$i]))
                                $kolom = '<td class="center-align">'.$rekap[$pin][$i].'</td>';
                            elseif ($rekap[$pin][$i] == 'NR') {
                                $kolom = '<td class="center-align">'.$rekap[$pin][$i].'</td>';
                                $nr = true;
                            } else
                                $kolom = '<td class="center-align yellow accent-2">A0</td>';
