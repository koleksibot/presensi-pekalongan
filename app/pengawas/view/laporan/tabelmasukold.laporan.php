                    ...
                    for ($i = 1; $i <= $hitungtgl; $i++) {
                        ...
                        if (isset($rekap[$pin][$i])) {
                            if (in_array($i, $libur)) { //jk libur nasional tpi finger
                                ...
                                $color = in_array($rekap[$pin][$i], ['M2', 'M3', 'M4', 'M5', 'M0']) ? 'yellow accent-2' : '';
                            ...
                            $kolom = '<td class="center-align yellow accent-2">M0</td>';
...
if ($download == 0 && $tingkat == 4 && 
    !isset($laporan['admin_kota']) && isset($laporan['kepala_opd']) &&
