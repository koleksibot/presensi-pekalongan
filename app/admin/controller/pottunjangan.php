...
class pottunjangan extends system\Controller {
    ...
    protected function index() {
        $data['title'] = 'PEMOTONGAN TUNJANGAN';
        $data['subtitle'] = 'Halaman Master - Pemotongan Tunjangan';
        $data['table_title'] = 'Tabel Master Pemotongan Tunjangan';
        $data['breadcrumb'] = '<nav class="custom">
          <div class="nav-wrapper">
            <div class="col s12">
              <a href="'.$this->link().'" class="breadcrumb">Beranda</a>
              <a href="#!" class="breadcrumb">Master Pemotongan Tunjangan</a>
            </div>
          </div>
        </nav>';
    ...
    public function form() {
        $input = $this->post(true);
        if ($input) {
            $data['form_title'] = (!(empty($input['id_pottunjangan']))) ? 'Ubah Data Pemotongan Tunjangan' : 'Tambah Data Pemotongan Tunjangan';
