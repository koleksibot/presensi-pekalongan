...
$batas_sahkan = strtotime($tahun.'-'.($bulan+1).'-4');
if ($tingkat == 4 && !isset($laporan['admin_kota']) && strtotime(date('Y-m-d')) >= $batas_sahkan
) {
?>
<div class="center-align">
    <a class="waves-effect waves-light blue btn" href="<?= $this->link('admin/HusnanWModerasi/daftarVerMod/'.$kdlokasi.'') ?>" style="margin-bottom: 10px; width: 250px"><i class="material-icons left">view_list</i>Verifikasi Moderasi</a>
    <form id="frmVer">
