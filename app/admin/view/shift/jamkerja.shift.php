...
<div class="card-content no-m-t no-m-r no-m-l">
    <span class="card-title">Jam Kerja</span>
    <ul class="planning no-margin" id="detailJam">
    ...
    <div class="card-panel no-s">
        <div class="chip">Awal Berlaku : <?= comp\FUNC::tanggal($dataShift['tanggal_mulai_shift'], 'long_date') ?></div>
        <div class="chip">Akhir Berlaku : <?= comp\FUNC::tanggal($dataShift['tanggal_akhir_shift'], 'long_date') ?></div>
