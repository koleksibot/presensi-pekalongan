    ...
    <div class="side-nav-wrapper">
        <div class="sidebar-profile">
            ...
            <div class="sidebar-profile-info">
                <a class="pointer">
                    ...
                    <span style="text-transform: lowercase"><?=$selfId['jabatan_pengguna']?> KEPALABKPPD@<?= $selfId["singkatan_lokasi"] ?></span>
                    <!-- ### -->
                </a>
            </div>
        </div>
        <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
            ...
            <li class="no-padding">
                ...
                <div class="collapsible-body">
                    <ul id="ulModerasi">
                        <li><a href="<?php //echo $link_husnanw_daftar_ver_mod_proses ?>"><i class="material-icons">star</i>Daftar Proses Moderasi</a></li>
                        <li><a href="<?php //echo $link_husnanw_daftar_ver_mod_hasil ?>"><i class="material-icons">star</i>Status Final Moderasi</a></li>
                    </ul>
                </div>
            </li>
            -->
            <li class="no-padding">
                ...
                <div class="collapsible-body">
                    <ul>
                        ...
                        <li><a href="<?= $link_laporan ?>">Lap Masuk Untuk Disahkan</a></li>
                        <li><a href="<?= $link_laporan_verified ?>">Lap Telah Disahkan</a></li>
                    </ul>
                </div>
            </li>
