        ...
        <div class="row">
            <div class="col s12 m11">
                <div class="card">
                    ...
                    <?php if ($info["flag_kepala_opd"] !== "2" && $info["flag_kepala_opd"] !== "3"): ?>
                        <textarea id="txtCatatan" class="materialize-textarea" placeholder="Berikanlah catatan Anda di sini..."><?= $info["catatan_kepala_kota"] ?></textarea>
                        <label for="txtCatatan" class="active">Catatan Kepala BKPPD</label>
                        <br>
