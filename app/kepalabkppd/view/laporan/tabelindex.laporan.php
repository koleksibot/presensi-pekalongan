...
<div class="col m4">
    ...
    <?php
        ...
        foreach ($laporan as $i) {
            if ($i['ver_admin_kota'] && !$i['sah_kepala_bkppd']) {
                echo '<li><a href="#" class="btnLap" data-lokasi="'.$i['kdlokasi'].'" data-bulan="'.$bulan.'" data-tahun="'.$tahun.'" title="Sahkan Laporan">'.$lokasi[$i['kdlokasi']].'</a></li>';
                unset($belum[$i['kdlokasi']]);
            }elseif ($i['sah_kepala_bkppd']) {
