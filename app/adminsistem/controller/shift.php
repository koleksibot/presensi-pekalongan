...
//            $data['dataShiftDetail'] = $this->presensi_service->getTabelKrit('tb_shift_detail', array('id_shift' => '2018011423542792'));
    ...
    protected function jamkerja() {
        ...
        if ($input) {
            $input['batas'] = '1000';
            $data['dataShift'] = $this->presensi_service->getDataKrit('tb_shift', $input);
            $data['dataShiftDetail'] = $this->presensi_service->getTabelKrit('tb_shift_detail', $input, 'startdays');
