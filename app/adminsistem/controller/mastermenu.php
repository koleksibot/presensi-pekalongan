...
class mastermenu extends system\Controller {
    ...
    protected function index() {
        ...
        $data['table_title'] = 'Tabel Master Panduan';
    ...
    public function cekprimary() {
        $input = $this->post(true);
        if ($input) {            
            $cek = $this->servicemasterpresensi->cekPrimaryKodePanduan($input['kd_panduan']);
    ...
    public function simpan() {
        ...
        if ($input) {
            ...
            if (!empty($_FILES['file']['name'])) {
                ...
                //$nmfile_server = $name . '_' . date('YmdHis') . $rand_number .'.'. $ext;
