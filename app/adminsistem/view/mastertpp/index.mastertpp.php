<body class="search-app quick-results-off loaded">
    ...
    <div class="mn-content fixed-sidebar">
                        ...
                        <div class="card-content">
                            <div class="col s12" style="margin-bottom: 15px">
                                <form id="frmData" class="navbar-search expanded" onsubmit="return false" role="search" >
                                    <div class="input-field col s7 custom-prefix hide">
                                    ...
                                    <div class="input-field right-align">
                                        ...
                                        <a id="" class="waves-effect waves-light btn purple btnBack hide"><i class="material-icons  arrow-l left">arrow_back</i> Kembali</a>
                                    </div>
        ...
        <div id="frmKecualiModal" class="modal">
            <form id="frmInputKecuali" class="form-horizontal" role="form" onsubmit="return false" autocomplete="off">
                <div class="modal-content">
                    <div id="data-form-input-kecuali"></div>
                </div>
                <div class="modal-footer right-align">
                    <button id="btnSimpanKecuali" type="submit" class="waves-effect waves-light btn green">Simpan</button>
                    <button id="btnBatalKecuali" type="button" class="modal-close waves-effect waves-light btn red">Batal</button>
                </div>
            </form>
        </div>
        <!-- /.modal -->
    ...
    <script>
            (function ($) {
                ...
                $(document).on("click", ".btnFormKecuali", function () {
                    app.showFormKecuali(this.id);
                });
                ...
                $(document).on("submit", "#frmInputKecuali", function () {
                    app.simpanKecuali(this);
                });
                ...
                $(document).on("click", ".btnHapusNot", function () {
                    app.hapuskecuali(this.id, $(this).data('tpp'));
                });
