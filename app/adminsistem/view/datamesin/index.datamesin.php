                            ...
                            <form id="frmData" class="navbar-search expanded" onsubmit="return false" role="search" >
                                ...
                                <div class="row">
                                    <div class="input-field col s4">
                                        <?= comp\MATERIALIZE::inputSelect('kd_kelompok_lokasi_kerja', $pil_kel_satker, 'style="margin-right: 10px"') ?>
                                        <label for="kd_kelompok_lokasi_kerja" class="active">Kelompok Lokasi Kerja</label>
                                    </div>
                                    <div class="input-field col s7">
                                        <?= comp\MATERIALIZE::inputSelect('kdlokasi', $pil_satker, '') ?>
                                        <label for="kdlokasi" class="active">Satuan Kerja</label>
                                    </div>
