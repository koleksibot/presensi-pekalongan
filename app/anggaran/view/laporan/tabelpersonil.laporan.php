...
<?= comp\MATERIALIZE::inputKey('lokasi', $kdlokasi); ?>
    ...
    <tbody>
        ...
        foreach ($dataTabel as $kol) {
            ...
            <tr>
                ...
                <td>
                    <?= comp\MATERIALIZE::inputCheckbox('pin_absen[' . $kol['pin_absen'] . ']', array($kol['pin_absen']), '', 'class="check-cetak" data-satker="'.$satker.'"') ?>
                </td>
                <td><?= $kol['nipbaru'] ?></td>
