...
<table class="bordered hoverable custom-border scrollable <?= (!isset($laporan['sah_final']) && $period != '12018' && $period != '22018') ? 'ini-draft' : '' ?>">
    ...
    <?php
    $no = 1; $pin_absen = '';
    $tot_tpp = 0; $tot_pot = 0; $tot_tppkotor = 0; $tot_pajak = 0; $tot_terima = 0; $tot_potbpjs = 0; $tot_terimapotbpjs = 0;
    foreach ($pegawai['value'] as $peg) {
        ...
        */
        ...
        /* acil 20200208 */
        $pot_bpjs = (($terima + $peg['totgaji']) > $kenabpjs['value']) ? ($kenabpjs['value'] - $peg['totgaji']) * 0.01 : $terima * 0.01;
